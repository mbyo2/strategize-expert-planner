-- Add superuser role and support ticket system

-- First update the user_role enum to include superuser
...
-- Create trigger for support ticket comments
...
-- Create the first superuser (you can update this with your desired email)
