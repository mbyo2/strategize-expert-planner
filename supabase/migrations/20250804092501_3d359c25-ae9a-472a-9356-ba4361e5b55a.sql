...
CREATE TABLE public.erp_entities (
  ...
  CONSTRAINT idx_erp_entities_org_module UNIQUE (organization_id, module_key, entity_type, id)
);
...
CREATE INDEX idx_erp_entities_org_module ON public.erp_entities(organization_id, module_key);
CREATE INDEX idx_erp_entities_type ON public.erp_entities(entity_type);
CREATE INDEX idx_erp_strategic_links_goal ON public.erp_strategic_links(strategic_goal_id);
CREATE INDEX idx_erp_strategic_links_initiative ON public.erp_strategic_links(planning_initiative_id);
CREATE INDEX idx_erp_strategic_links_entity ON public.erp_strategic_links(erp_entity_id);
